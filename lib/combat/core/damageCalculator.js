...
export function calcularDanoHabilidade({
  ...
  // 2. Roubo de vida dos efeitos da habilidade (Sombra)
  ...
  if (efeitosRouboVida.length > 0) {
    ...
    const percentuaisRoubo = {
      'roubo_vida': 0.15,          // 15% do dano
      'roubo_vida_intenso': 0.30,  // 30% do dano
      'roubo_vida_massivo': 0.40,  // 40% do dano
 ...
 */
export function calcularCuraHabilidade({ habilidade, myAvatar, modificadoresSinergia = {} }) {
