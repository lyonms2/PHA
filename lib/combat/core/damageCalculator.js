...
export function calcularDanoHabilidade({
  ...
  console.log('📊 [DANO PASSO 1] Cálculo inicial:', {
    danoBase: danoBaseHab,
    stat: `${statPrimario}: ${statValue}`,
    multiplicador: multiplicadorStat,
    bonusStat: statValue * multiplicadorStat,
    random: random,
    danoInicial: dano
  });
  ...
  console.log('📊 [DANO PASSO 2] Após resistência:', {
    resistenciaOponente,
    resistenciaFinal,
    reducao: Math.floor(reducaoResistencia),
    danoAposResistencia: Math.floor(dano)
  });
  ...
  console.log('📊 [DANO PASSO 3] Após vínculo:', {
    vinculo: `${vinculo}%`,
    bonusVinculo,
    danoAposVinculo: Math.floor(dano)
  });
  ...
  console.log('📊 [DANO PASSO 4] Após elemental:', {
    elementalMult: elemental.mult,
    tipo: elemental.tipo,
    danoAntesElemental: Math.floor(danoAntesElemental),
    danoAposElemental: Math.floor(dano)
  });
  ...
  console.log('📊 [DANO PASSO 5] Final (antes de múltiplos golpes):', {
    critico,
    danoAntesCritico: Math.floor(danoAntesCritico),
    danoAposCritico: critico ? Math.floor(danoAntesBloqueio) : '-',
    bloqueado,
    danoFinal: dano
  });
