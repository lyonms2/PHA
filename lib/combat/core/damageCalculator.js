...
export function calcularDanoAtaque({
  ...
  // Aplicar modificadores de sinergia do ATACANTE que afetam resistência do INIMIGO
  ...
  if (modificadoresSinergia.resistencia) {
    ...
    console.log(`%c🛡️ SINERGIA DE RESISTÊNCIA (Atacante afeta Defensor): ${percentual >= 0 ? '+' : ''}${percentual}%`,
