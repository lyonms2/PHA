...
import { getSynergyContraInimigo, formatarSinergiaParaLog, formatarModificadores } from './synergySystem';
...
export function previewSinergia(elementoSuporte, raridadeSuporte = 'Comum') {
  ...
  // Importar as sinergias do sistema
  const { SYNERGIES_SIMPLIFIED } = require('./synergySystem');
