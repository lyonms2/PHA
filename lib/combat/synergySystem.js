...
export const SYNERGIES_SIMPLIFIED = {
  ...
  // ========== VOID (DESTRUIÇÃO ABSOLUTA) ==========
  [ELEMENTOS.VOID]: {
    tipo: 'Destruição',
    descricao: 'Elemento focado em aniquilação e dano massivo',

    // Modificadores baseados no elemento do INIMIGO
    contrainimigo: {
      [ELEMENTOS.AETHER]: {
        nome: 'Aniquilação Dimensional',
        modificadores: {
          dano_habilidades: 0.25 // +25% dano de habilidades ofensivas
        },
        descricao: 'Vazio destrói a criação'
      },

      // Todos os outros elementos (Fogo, Água, Terra, Vento, Eletricidade, Luz, Sombra, Void)
      default: {
        nome: 'Vácuo Destrutivo',
        modificadores: {
          dano_habilidades: 0.20 // +20% dano de habilidades ofensivas
        },
        descricao: 'Vazio consome tudo'
      }
    }
  },

  // ========== AETHER (CRIAÇÃO/ANTI-VOID) ==========
  [ELEMENTOS.AETHER]: {
    tipo: 'Criação',
    descricao: 'Elemento focado em criação e proteção absoluta',

    // Modificadores baseados no elemento do INIMIGO
    contrainimigo: {
      [ELEMENTOS.VOID]: {
        nome: 'Gênese Restauradora',
        modificadores: {
          dano_habilidades: 0.25 // +25% dano de habilidades ofensivas
        },
        descricao: 'Criação anula o vazio'
      },

      // Todos os outros elementos (Fogo, Água, Terra, Vento, Eletricidade, Luz, Sombra, Aether)
      default: {
        nome: 'Escudo Primordial',
        modificadores: {
          resistencia: 0.20 // +20% resistência/defesa
        },
        descricao: 'Criação protege contra tudo'
      }
    }
  }
};
