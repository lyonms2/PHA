...
export const SYNERGIES = {
  ...
  [ELEMENTOS.FOGO]: {
    [ELEMENTOS.FOGO]: {
      ...
      desvantagem: { tipo: 'energia_max', valor: -0.20 },
    ...
    [ELEMENTOS.ELETRICIDADE]: {
      ...
      desvantagem: { tipo: 'custo_energia', valor: 0.15 },
    ...
    [ELEMENTOS.SOMBRA]: {
      ...
      desvantagem: { tipo: 'hp_max', valor: -0.10 },
    ...
    [ELEMENTOS.VOID]: {
      ...
      desvantagem: { tipo: 'hp_max', valor: -0.15 },
      descricao: 'Fogo que consome tudo'
    },
    [ELEMENTOS.AETHER]: {
      nome: 'Chama Primordial',
      vantagem1: { tipo: 'dano', valor: 0.25 },
      vantagem2: { tipo: 'energia_max', valor: 0.15 },
      desvantagem: null,
  ...
  [ELEMENTOS.AGUA]: {
    ...
    [ELEMENTOS.SOMBRA]: {
      ...
      desvantagem: { tipo: 'cura', valor: -0.30 },
    ...
    [ELEMENTOS.VOID]: {
      ...
      desvantagem: { tipo: 'energia_max', valor: -0.25 },
      descricao: 'Água do vazio que drena energia'
    },
    [ELEMENTOS.AETHER]: {
      nome: 'Fonte da Vida',
      vantagem1: { tipo: 'cura', valor: 0.35 },
      vantagem2: { tipo: 'hp_max', valor: 0.15 },
      desvantagem: { tipo: 'dano', valor: -0.20 },
  ...
  [ELEMENTOS.TERRA]: {
    ...
    [ELEMENTOS.TERRA]: {
      ...
      vantagem2: { tipo: 'hp_max', valor: 0.20 },
    ...
    [ELEMENTOS.SOMBRA]: {
      ...
      vantagem1: { tipo: 'resistencia', valor: 0.25 },
      vantagem2: { tipo: 'roubo_vida', valor: 0.15 },
      desvantagem: { tipo: 'cura', valor: -0.40 },
    ...
    [ELEMENTOS.AETHER]: {
      nome: 'Rocha Eterna',
      vantagem1: { tipo: 'resistencia', valor: 0.30 },
      vantagem2: { tipo: 'hp_max', valor: 0.25 },
      desvantagem: { tipo: 'evasao', valor: -0.15 },
  ...
  [ELEMENTOS.ELETRICIDADE]: {
    ...
    [ELEMENTOS.VENTO]: {
      ...
      vantagem1: { tipo: 'dano', valor: 0.25 },
      vantagem2: { tipo: 'evasao', valor: 0.15 },
      desvantagem: { tipo: 'custo_energia', valor: 0.10 },
      descricao: 'Raios velozes'
    },
    [ELEMENTOS.ELETRICIDADE]: {
      nome: 'Sobrecarga',
      vantagem1: { tipo: 'dano', valor: 0.30 },
      vantagem2: { tipo: 'energia_max', valor: 0.25 },
      desvantagem: { tipo: 'hp_max', valor: -0.10 },
    ...
    [ELEMENTOS.AETHER]: {
      ...
      vantagem1: { tipo: 'dano', valor: 0.28 },
      vantagem2: { tipo: 'energia_max', valor: 0.30 },
      desvantagem: null,
  ...
  [ELEMENTOS.LUZ]: {
    ...
    [ELEMENTOS.VOID]: {
      ...
      vantagem1: { tipo: 'dano', valor: 0.30 },
      vantagem2: { tipo: 'resistencia_inimigo', valor: -0.25 },
      desvantagem: { tipo: 'cura', valor: -0.25 },
  ...
  [ELEMENTOS.SOMBRA]: {
    ...
    [ELEMENTOS.AGUA]: {
      ...
      desvantagem: { tipo: 'cura', valor: -0.50 },
    ...
    [ELEMENTOS.TERRA]: {
      ...
      vantagem1: { tipo: 'resistencia', valor: 0.20 },
      vantagem2: { tipo: 'roubo_vida', valor: 0.25 },
      desvantagem: { tipo: 'cura', valor: -0.60 },
    ...
    [ELEMENTOS.SOMBRA]: {
      ...
      desvantagem: { tipo: 'cura', valor: -0.70 },
    ...
    [ELEMENTOS.VOID]: {
      ...
      desvantagem: { tipo: 'hp_max', valor: -0.25 },
    ...
    [ELEMENTOS.AETHER]: {
      ...
      vantagem1: { tipo: 'dano', valor: 0.25 },
      vantagem2: { tipo: 'roubo_vida', valor: 0.25 },
      desvantagem: { tipo: 'cura', valor: -0.20 },
  ...
  [ELEMENTOS.VOID]: {
    ...
    [ELEMENTOS.AGUA]: {
      ...
      vantagem1: { tipo: 'dano', valor: 0.25 },
      vantagem2: { tipo: 'energia_inimigo', valor: -0.35 },
      desvantagem: { tipo: 'energia_max', valor: -0.30 },
    ...
    [ELEMENTOS.LUZ]: {
      ...
      desvantagem: { tipo: 'cura', valor: -0.35 },
    ...
    [ELEMENTOS.SOMBRA]: {
      ...
      vantagem2: { tipo: 'roubo_vida', valor: 0.35 },
      desvantagem: { tipo: 'hp_max', valor: -0.30 },
    ...
    [ELEMENTOS.VOID]: {
      ...
      desvantagem: { tipo: 'hp_max', valor: -0.35 },
    ...
    [ELEMENTOS.AETHER]: {
      ...
      vantagem2: { tipo: 'resistencia_inimigo', valor: -0.40 },
      desvantagem: { tipo: 'hp_max', valor: -0.40 },
  ...
  [ELEMENTOS.AETHER]: {
    ...
    [ELEMENTOS.TERRA]: {
      ...
      vantagem1: { tipo: 'resistencia', valor: 0.30 },
      vantagem2: { tipo: 'hp_max', valor: 0.30 },
      desvantagem: { tipo: 'evasao', valor: -0.20 },
    ...
    [ELEMENTOS.SOMBRA]: {
      ...
      vantagem1: { tipo: 'dano', valor: 0.28 },
      vantagem2: { tipo: 'roubo_vida', valor: 0.25 },
      desvantagem: { tipo: 'cura', valor: -0.15 },
