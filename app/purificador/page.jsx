            ...
            <div className="container mx-auto px-3 md:px-4 py-3 max-w-7xl">
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="px-3 py-2 text-xs gap-1.5 bg-gradient-to-r from-cyan-900/30 to-blue-900/30 hover:from-cyan-800/40 hover:to-blue-800/40 border border-cyan-500/30 text-cyan-400 rounded-lg transition-all flex items-center font-semibold whitespace-nowrap active:scale-95 hover:scale-105"
                >
                  <span>👥</span>
                  <span>AVATARES</span>
                </button>
